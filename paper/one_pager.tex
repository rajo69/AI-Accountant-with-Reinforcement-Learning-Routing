...
signal [Kadavath+2022, Xiong+2024]; multi-seed training; a larger
seed-independent eval set to separate statistical power from seed-level
dependence; extension to the parent pipeline's reconciliation agent.
